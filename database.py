    ...
    def init_database(self):
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS screening_results (
                ...
                q1_routine VARCHAR(10),
                q2_repeats VARCHAR(10),
                q3_focus VARCHAR(10),
                q4_empathy VARCHAR(10),
                q5_changes VARCHAR(10),
                q6_socializing VARCHAR(10),
                q7_friends VARCHAR(10),
                q8_movements VARCHAR(10),
                q9_eye_contact VARCHAR(10),
                q10_expressions VARCHAR(10),
                total_score INTEGER,
